...
class TestModels:
    ...
    def test_games_shuffled(self):
        ...
        newman = get_predictions('newman', data_dict, pi_values)
        shuffled_newman = get_predictions('newman', shuffled_data_dict, pi_values)
    ...
    def test_leadership_shuffled(self):
        ...
        # Get predictions from each model
        newman = get_predictions('newman_leadership', data_dict, pi_values)
        shuffled_newman = get_predictions('newman_leadership', shuffled_data_dict, pi_values)
