...
def process_directory(base_path):
    ...
    rms_df.to_csv(os.path.join(base_path, 'results', 'rms_summary.csv'), index=False)
    rho_df.to_csv(os.path.join(base_path, 'results', 'rho_summary.csv'), index=False)
    tau_df.to_csv(os.path.join(base_path, 'results', 'tau_summary.csv'), index=False)
...
def process_directory_c(base_path):
    os.makedirs(os.path.join(base_path, 'results'), exist_ok=True)
